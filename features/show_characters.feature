Feature: Show all RPG characters
  ...
  I want to be able to view the characters I have created in one place
  
Scenario: As an RPG character generator user I want to navigate from the welcome page to the characters listing
